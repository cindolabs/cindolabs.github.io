...
def save_to_github(df):
 ...
 st.error("GitHub token tidak ditem ukan di secrets.toml! Data disimpan lokal.")
...
def calculate_summary(df):
 ...
 "dana_kelolaan": DANA_KELOLAAN_BARU # Gunakan dana kelolaan baru
 }
 except Exception as e:
...
# Hitung pembagian dana kelolaan per investor
...
def calculate_investor_earnings(df, roi_percent):
 ...
 logger.warning("DataFrame empty or invalid ROI for earnings calculation")
...
if check_login():
 ...
 fig = px.bar(daily_sum, x="tanggal", y="nominal", title="Investasi per Tang gal")
 else: # Line Saldo
